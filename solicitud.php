...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 align="center">Solicitud de compra de material.</h2>
				<br>
            </div>
        </div>
		
		<form name="solicitud" align="center" method="post" action="inssolicitud.php">
		<p>
			Aparato: <input type="text" name="aparato">
		</p>
		<p>
		...
		<p>
			Número de Serie: <input type="text" name="nserie">
		</p>
		<p>
			Cantidad: <input type="text" name="cantidad">
		</p>
		<p>
			Fecha de Entrada: <input type="date" name="fcEntrada">
		</p>
		<p>
			Garantia: <input type="text" name="garantia">
		</p>
