...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 align="center">Tabla de software disponible.</h2>
								<br>
            </div>
        </div>
        <!-- /.row -->
		<?php
			include("conexion.php");
			//creamos la consulta
			$consulta="SELECT idLicencia,nombre,tipoLicencia,cantidad,fechaFin,observaciones
			FROM software";
			...
			while ($linea = mysqli_fetch_array($registro))
			{
				echo "<table class='table table-hover'>
						<tr>
							<td>$linea[idLicencia]</td>
							<td>$linea[nombre]</td>
							<td>$linea[tipoLicencia]</td>
							<td>$linea[cantidad]</td>
							<td>$linea[fechaFin]</td>
