...
<?php
	...
	die("Error en la conexion con la base de datos"); //mysqli_error()	
?>
    <!-- Navigation -->
    ...
    <div class="container">
        ...
        <header class="jumbotron hero-spacer">
            <h1 align="center">Contabilizador de Materiales del Colegio Salesianos de Zaragoza</h1>
            </p>
        </header>
        ...
        <div class="row text-center">
            ...
            <div>
              	<form name="usuarios" id="usuarios" method="post" action="login.php">
					<p>
						<input type="text" name="dni" id="dni" placeholder="DNI (sin letra)" >
					</p>
					<p>
						<input type="password" name="clave" id="clave" placeholder="Clave (máx.11 carácteres)" >
					</p>
