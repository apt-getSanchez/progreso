...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 align="center">Tabla de materiales no disponibles.</h2>
								<br>
            </div>
        </div>
        <!-- /.row -->
		<?php
			include("conexion.php");
			//creamos la consulta
			$consulta="SELECT idReferencia,aparato,categoria,marca,modelo,garantia,ubicacion,nInterno,fechaBaja,observaciones 
			FROM bajas";
			...
			while ($linea = mysqli_fetch_array($registro))
			{
				echo "<table class='table table-hover'>
						<tr scope='row'>
							...
							<td><a href='liberamat.php?clave=$linea[idReferencia]'>Desocupar</a></td>
					  </tr></table>";
			}
